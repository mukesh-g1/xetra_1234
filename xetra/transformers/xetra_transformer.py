...
class XetraSourceConfig(NamedTuple):
    ...
    src_first_extract_data: determines the date for extracting the source
...
class XetraTargetConfig(NamedTuple):
    ...
    trg_col_dail_tard_vol: column name for daily traded volume in target
